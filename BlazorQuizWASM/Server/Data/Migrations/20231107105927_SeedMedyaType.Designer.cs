...
namespace BlazorQuizWASM.Server.Data.Migrations
{
    ...
    [Migration("20231107105927_SeedMedyaType")]
    partial class SeedMedyaType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazorQuizWASM.Server.Models.Domain.MediaType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MediaId = new Guid("1b9aa505-9c0d-4601-8563-73b820bc6c45"),
                            Mediatype = "image"
                        },
                        new
                        {
                            MediaId = new Guid("8445a089-8109-4d5d-9ddf-026e166a3866"),
                            Mediatype = "video"
                        });
                });
