...
namespace BlazorQuizWASM.Server.Data.Migrations
{
    ...
    [Migration("20231113094028_DesignQuestionandQuizItemÙpdate")]
    partial class DesignQuestionandQuizItemÙpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazorQuizWASM.Server.Models.Domain.MediaType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MediaId = new Guid("7427e04d-cef2-4c8a-8c77-238c2270927c"),
                            Mediatype = "image"
                        },
                        new
                        {
                            MediaId = new Guid("2a7723a4-6c2b-4ce8-ac6b-ab3b924e6aeb"),
                            Mediatype = "video"
                        });
                });
