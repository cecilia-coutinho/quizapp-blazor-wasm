...
namespace BlazorQuizWASM.Server.Data.Migrations
{
    ...
    [Migration("20231113123955_QuestionsTableUpdate")]
    partial class QuestionsTableUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazorQuizWASM.Server.Models.Domain.MediaType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MediaId = new Guid("935ca202-8458-41b9-ae85-3484774eb911"),
                            Mediatype = "image"
                        },
                        new
                        {
                            MediaId = new Guid("da449e2d-fc7b-4886-90a2-fc8b32da0b3f"),
                            Mediatype = "video"
                        });
                });
